...
<param name="movie" value="player<?php echo $files[0]['aspect']; ?>.swf?flvFilename=<?php echo $_GET['url']; ?>" />
<param name="allowFullScreen" value="true" />
<param name="quality" value="high" />
<param name="bgcolor" value="#" />
<embed src="player<?php echo $files[0]['aspect']; ?>.swf?flvFilename=<?php echo $_GET['url']; ?>" width="<?php echo $files[0]['width']; ?>" height="<?php echo $files[0]['height']; ?>" bgcolor="#" name="flash" quality="high" align="middle" allowscriptaccess="sameDomain" allowfullscreen="true" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
